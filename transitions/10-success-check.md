...
If the dasharray is too short the stroke pre-reveals before the animation starts. If it is too long, the path appears to draw past its end before fading in. Round up by 1px to absorb sub-pixel float jitter.
